//this perticular function get the value of bath when selected in ui like 2 or 3
...
//same like above give get the bhk value
...
function onClickedEstimatePrice() {
   ...
   //we get the output back using these post call get like get output estimated price in lakhs
    $.post(url, {
...
//load the html page when get data locations dropdown  get data response back
//iterate one by one add those location to dropdown
function onPageLoad() {
